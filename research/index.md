...
### Co-authored
* R. A. Lewis-Merrill, et al, incl. **A. K. Gautam**. *Absolute Motion of the Infrared Counterpart to Sagittarius A\* in the Gaia Celestial Reference Frame 3 and Limits on an Intermediate-mass Black Hole Companion*<br>Journal (open access): [ApJ, 1009:16, 2026](https://doi.org/10.3847/1538-4357/ae878c) <br>Preprint (open access): [arXiv:2609.04077](https://arxiv.org/abs/2609.04077)
* R. Bentley, et al, incl. **A. K. Gautam**. *A Kinematic Study of Wolf–Rayet Stars at the Galactic Center. I. Binary Candidates and Constraints on the Binary Fraction*<br>Journal (open access): [ApJ, 1006:71, 2026](https://doi.org/10.3847/1538-4357/ae82d6) <br>Preprint (open access): [arXiv:2606.05521](https://arxiv.org/abs/2606.05521)
